...
print(plt.show())
print(plt.plot(Games[0],ls=':',marker='s',color='red',ms=3,label="Dhoni"))
print(plt.plot(Games[1],ls=':',marker='o',color='blue',ms=3,label="Virat"))
print(plt.plot(Games[2],ls=':',marker='^',color='green',ms=3,label="Archer"))
print(plt.plot(Games[3],ls=':',marker='*',color='yellow',ms=3,label="Sachin"))
print(plt.xticks(list(range(0,10)),Seasons,rotation='vertical'))
print(plt.legend(loc='best'))
print(plt.show())